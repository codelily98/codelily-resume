...
로컬 PostgreSQL에 이력서를 저장하고, A4 미리보기와 브라우저 인쇄 기능으로 회사 제출용 PDF를 만드는 Next.js 애플리케이션입니다.
...
- 사진과 증빙 파일은 `data/uploads/<resumeId>/`에 저장됩니다.
...
- 로컬 단일 사용자 도구이므로 로그인과 권한 기능이 없습니다.
